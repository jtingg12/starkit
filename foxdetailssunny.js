...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const characterData = [
        { id: 'personality', imgSrc: 'images/foxfriends/sunny.png', position: 'right' },
        { id: 'strengths', imgSrc: 'images/foxfriends/d2.png', position: 'left' },
        { id: 'growth', imgSrc: 'images/foxfriends/sunny.png', position: 'right' },
        { id: 'notice', imgSrc: 'images/foxfriends/d2.png', position: 'left' },
        { id: 'learn', imgSrc: 'images/foxfriends/sunny.png', position: 'right' },
    ];
