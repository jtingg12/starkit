document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- 新增: 设置 SEE ALL 按钮链接 ---
    // 1. 确认当前页面的角色名 (请在其他文件改为对应角色)
    const characterName = 'ruby'; 
    
    // 2. 假设你的 “SEE ALL” 按钮/链接有一个 ID 叫 'seeAllButton'
    const seeAllButton = document.getElementById('seeAllButton'); 
    
    if (seeAllButton) {
        // 设置链接：返回主页，并带上 ?fox=ruby 参数
        seeAllButton.href = `FoxFriends.html?fox=${characterName}`;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const characterData = [
        { id: 'personality', imgSrc: 'images/foxfriends/ruby.png', position: 'right' },
        { id: 'strengths', imgSrc: 'images/foxfriends/d1.png', position: 'left' },
        { id: 'growth', imgSrc: 'images/foxfriends/ruby.png', position: 'right' },
        { id: 'notice', imgSrc: 'images/foxfriends/d1.png', position: 'left' },
        { id: 'learn', imgSrc: 'images/foxfriends/ruby.png', position: 'right' },
    ];
