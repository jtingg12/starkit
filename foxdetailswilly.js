...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const characterData = [
        { id: 'personality', imgSrc: 'images/foxfriends/willy.png', position: 'right' },
        { id: 'strengths', imgSrc: 'images/foxfriends/d3.png', position: 'left' },
        { id: 'growth', imgSrc: 'images/foxfriends/willy.png', position: 'right' },
        { id: 'notice', imgSrc: 'images/foxfriends/d3.png', position: 'left' },
        { id: 'learn', imgSrc: 'images/foxfriends/willy.png', position: 'right' },
    ];
